...
import $ from "jquery";
// import useScript from 'async_hooks/useScript';

// import './particleBg'

class LoginPage extends Component{
    // useScript('https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js');
    // useScript('particleBg.js');
    render(){
        return(
            <div className="content" id="jsi-particle-container">
            <div className="login">
                <h1>Вход</h1>
                <form method="post">
    ...
    componentDidMount(){
        ...
        PARTICLE.prototype = {
            ...
            init : function(){
                ...
                this.vx = this.getRandomValue(-2, 1);
                this.vy = this.getRandomValue(-2, 1);
                this.ax = 0;
                this.ay = 0;
                this.gravity = false;
                this.transformShape();
